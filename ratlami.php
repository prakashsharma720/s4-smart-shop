    ...
    <div class="product-container">
        ...
        <div class="product-images">
            <div class="thumbnails">
                <img src="img/Chevda namkeen.jpeg" alt="Front View" onclick="changeImage(this)" class="active">
                <img src="img/Mix namkeen.jpeg" alt="Side View" onclick="changeImage(this)">
                <img src="img/Bikaji - Ratlami Chatpata Sev Bhujia.jpeg" alt="Back View" onclick="changeImage(this)">
            </div>

            <div class="main-image">
                <img id="productImage" src="img/AdobeStock_481358705_Preview.jpeg" alt="Sev">
            </div>
        </div>

            <!-- Right: Details -->
            <div class="product-details">
                <h1>Ratlami namkeen</h1>
                <div class="price mb-2">Price: Rs. <span id="productPrice">185</span>.00</div>

                <div class="weight-section mb-2">
                    <strong>Weight:</strong>
                    <div class="weights">
                        <button data-price="70" onclick="selectWeight(this)">500g</button>
                        <button data-price="185" class="active" onclick="selectWeight(this)">1kg</button>
                    </div>
                </div>
