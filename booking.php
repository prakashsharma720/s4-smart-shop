                    ...
                    <div class="box_general_3 cart">
                        <div class="message">
                            ...
                            <div class="referral-box">
                                ...
                                <small id="referralMsg" class="text-success d-none mt-1">Referral applied successfully
                                    🎉</small>
                            </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="firstname_booking"
                                            name="firstname_booking" placeholder="Jhon">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lastname_booking"
                                            name="lastname_booking" placeholder="Doe">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email_booking_2" name="email_booking_2"
                                            class="form-control" placeholder="jhon@doe.com">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="telephone_booking" name="telephone_booking"
                                            class="form-control" placeholder="00 44 678 94329">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="step">
                            ...
                            <p>
                                ...
                                vocent ornatus molestie, reque fierent dissentiunt mel ea.
                            </p>
                            <p>
                        ...
                        <div id="policy">
                            ...
                            <div class="form-group">
                                <div class="checkboxes">
                                    <label class="container_check">I accept <a href="#0">terms and conditions and
                                            general policy</a>
                                        <input type="checkbox">
