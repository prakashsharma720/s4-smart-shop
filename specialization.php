...
<div class="container margin_120_95">
                <div class="main_title">
                    ...
                    <p>Nec graeci sadipscing disputationi ne, mea ea nonumes percipitur. Nonumy ponderum oporteat cu mel,
                        pro movet cetero at.</p>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <a href="list.php" class="box_cat_home">
