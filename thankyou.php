...
<body>
    ...
    <main class="thankyou-wrapper">
        <div class="thankyou-left">
            ...
            <p>Your order has been received. We will process it within 24 hours and send the shipping details to your
                email.</p>
            ...
            <div class="billing-info text-start rounded shadow-sm">
                <h5 class="mb-3 p-2" style="background:#f8f9fa; border:1px solid #dee2e6;"><i
                        class="bi bi-truck me-2"></i>Shipping/Billing Details</h5>
            ...
            <!-- <div class="row mb-2 mt-3">
                ...
                <div class="col-md-6">
                    ...
                    <a href="https://wa.me/8529257675?text=Hello!%20I%20have%20completed%20my%20payment%20for%20Order%20<?= urlencode($orderNumber) ?>.%20Please%20confirm."
                        target="_blank" class="btn btn-success d-flex align-items-center justify-content-center gap-2">
                        <img src="<?= $base_url; ?>img/WhatsApp.webp" alt="WhatsApp" style="width:24px;height:24px;">
                        WhatsApp </a>
                </div>
            </div><br> -->
        ...
        <div class="order-summary">
            <div class="justify-content-end mb-3">
                <h5 class="p-2" style="background:#f8f9fa; border:1px solid #dee2e6;"><i class="bi bi-book me-2"></i>
                    Order Summary</h5>
            </div>
...
?>
            ...
            <div class="order-pricing">
                ...
                <div class="price-total"><span>Order
                        Total</span><span>₹<?= number_format($total_with_shipping,2) ?></span></div>
            </div>
              <hr>
             <div class="row  mt-5">
                <div class="col-md-6">
